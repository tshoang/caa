%%
%% This is file `sample-answers-colour.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% caa.dtx  (with options: `sampleanswerscolour')
%% 
...
\title{Sample Document for CAA package\\
  (with answers and colour)}
\author{%
  Thai Son Hoang\\
...
\endinput
%%
%% End of file `sample-answers-colour.tex'.
